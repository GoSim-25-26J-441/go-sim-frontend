              ...
              ({ step, label }, idx) => {
                ...
                return (
                  <div key={step} className="flex items-center gap-2">
                    <div
                      className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold ${isActive
                          ? "bg-white text-black"
                          : isCompleted
                      ...
                      {(
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1 rounded-md transition-colors ${active
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                  <div className="flex-1 min-w-[200px]">
                                    ...
                                    <input
                                      ...
                                      className={`w-full px-3 py-1.5 bg-black/40 rounded text-sm text-white font-mono focus:outline-none focus:ring-2 ${endpointPathErrors[`${svcIndex}-${epIndex}`]
